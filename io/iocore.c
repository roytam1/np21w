...
//	TRACEOUT(("iocore_out16(%.4x, %.4x)", port, dat));
	...
	if(np2clvga.enabled && cirrusvga_opaque){
		if(np2clvga.gd54xxtype == CIRRUS_98ID_WAB || np2clvga.gd54xxtype == CIRRUS_98ID_WSN || np2clvga.gd54xxtype == CIRRUS_98ID_WSN2 || np2clvga.gd54xxtype == CIRRUS_98ID_GA98NB){
