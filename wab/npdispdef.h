...
#define NPDISP_DDCAPS2_NOPAGELOCKREQUIRED     0x00000800UL
...
#define NPDISP_DD_ROP_SPACE	(256 / 32)
	...
	// surface単位のBlt color keyまでを含むDDRAWI surface情報。
	typedef struct {
	...
	// DirectDraw 1/2のDDBLTFX。dwFillColorはoffset 80の転送先pixel値。
	typedef struct {
		UINT32 dwSize;
		UINT32 dwDDFX;
		UINT32 dwROP;
		UINT8 beforeFillColor[68];
		UINT32 dwFillColor;
